...
init_full_help_array(void)
{
  ...
  RNAsubopt_args_info_full_help[15] = RNAsubopt_args_info_detailed_help[16];
  ...
  RNAsubopt_args_info_full_help[18] = RNAsubopt_args_info_detailed_help[21];
  RNAsubopt_args_info_full_help[19] = RNAsubopt_args_info_detailed_help[22];
  RNAsubopt_args_info_full_help[20] = RNAsubopt_args_info_detailed_help[23];
  ...
  RNAsubopt_args_info_full_help[30] = RNAsubopt_args_info_detailed_help[37];
  RNAsubopt_args_info_full_help[31] = RNAsubopt_args_info_detailed_help[38];
  ...
  RNAsubopt_args_info_full_help[35] = RNAsubopt_args_info_detailed_help[45];
  RNAsubopt_args_info_full_help[36] = RNAsubopt_args_info_detailed_help[46];
  ...
  RNAsubopt_args_info_full_help[41] = 0; 
  
}

const char *RNAsubopt_args_info_full_help[42];
...
init_help_array(void)
{
  ...
  RNAsubopt_args_info_help[15] = RNAsubopt_args_info_detailed_help[16];
  ...
  RNAsubopt_args_info_help[18] = RNAsubopt_args_info_detailed_help[21];
  RNAsubopt_args_info_help[19] = RNAsubopt_args_info_detailed_help[22];
  RNAsubopt_args_info_help[20] = RNAsubopt_args_info_detailed_help[23];
  ...
  RNAsubopt_args_info_help[23] = RNAsubopt_args_info_detailed_help[28];
  RNAsubopt_args_info_help[24] = RNAsubopt_args_info_detailed_help[31];
  ...
  RNAsubopt_args_info_help[29] = RNAsubopt_args_info_detailed_help[37];
  RNAsubopt_args_info_help[30] = RNAsubopt_args_info_detailed_help[38];
  ...
  RNAsubopt_args_info_help[34] = RNAsubopt_args_info_detailed_help[45];
  RNAsubopt_args_info_help[35] = RNAsubopt_args_info_detailed_help[46];
  RNAsubopt_args_info_help[36] = RNAsubopt_args_info_detailed_help[48];
  RNAsubopt_args_info_help[37] = RNAsubopt_args_info_detailed_help[54];
...
void init_args_info(struct RNAsubopt_args_info *args_info)
{
  ...
  args_info->canonicalBPonly_help = RNAsubopt_args_info_detailed_help[13] ;
  args_info->enforceConstraint_help = RNAsubopt_args_info_detailed_help[14] ;
  args_info->shape_help = RNAsubopt_args_info_detailed_help[15] ;
  args_info->shapeMethod_help = RNAsubopt_args_info_detailed_help[16] ;
  args_info->shapeConversion_help = RNAsubopt_args_info_detailed_help[18] ;
  args_info->deltaEnergy_help = RNAsubopt_args_info_detailed_help[22] ;
  args_info->deltaEnergyPost_help = RNAsubopt_args_info_detailed_help[23] ;
  args_info->sorted_help = RNAsubopt_args_info_detailed_help[25] ;
  args_info->stochBT_help = RNAsubopt_args_info_detailed_help[27] ;
  args_info->stochBT_en_help = RNAsubopt_args_info_detailed_help[28] ;
  args_info->pfScale_help = RNAsubopt_args_info_detailed_help[29] ;
  args_info->circ_help = RNAsubopt_args_info_detailed_help[31] ;
  args_info->dos_help = RNAsubopt_args_info_detailed_help[32] ;
  args_info->zuker_help = RNAsubopt_args_info_detailed_help[34] ;
  args_info->gquad_help = RNAsubopt_args_info_detailed_help[35] ;
  args_info->temp_help = RNAsubopt_args_info_detailed_help[37] ;
  args_info->noTetra_help = RNAsubopt_args_info_detailed_help[38] ;
  args_info->dangles_help = RNAsubopt_args_info_detailed_help[40] ;
  args_info->noLP_help = RNAsubopt_args_info_detailed_help[42] ;
  args_info->noGU_help = RNAsubopt_args_info_detailed_help[44] ;
  args_info->noClosingGU_help = RNAsubopt_args_info_detailed_help[45] ;
  args_info->logML_help = RNAsubopt_args_info_detailed_help[46] ;
  args_info->paramFile_help = RNAsubopt_args_info_detailed_help[48] ;
  args_info->nsp_help = RNAsubopt_args_info_detailed_help[50] ;
  args_info->betaScale_help = RNAsubopt_args_info_detailed_help[52] ;
