...
init_full_help_array(void)
{
  ...
  RNAcofold_args_info_full_help[18] = RNAcofold_args_info_detailed_help[23];
  RNAcofold_args_info_full_help[19] = RNAcofold_args_info_detailed_help[24];
  RNAcofold_args_info_full_help[20] = RNAcofold_args_info_detailed_help[26];
  RNAcofold_args_info_full_help[21] = RNAcofold_args_info_detailed_help[28];
  RNAcofold_args_info_full_help[22] = RNAcofold_args_info_detailed_help[30];
  RNAcofold_args_info_full_help[23] = RNAcofold_args_info_detailed_help[32];
  RNAcofold_args_info_full_help[24] = RNAcofold_args_info_detailed_help[34];
  RNAcofold_args_info_full_help[25] = RNAcofold_args_info_detailed_help[36];
  ...
  RNAcofold_args_info_full_help[29] = RNAcofold_args_info_detailed_help[41];
  RNAcofold_args_info_full_help[30] = RNAcofold_args_info_detailed_help[43];
  RNAcofold_args_info_full_help[31] = RNAcofold_args_info_detailed_help[45];
  RNAcofold_args_info_full_help[32] = RNAcofold_args_info_detailed_help[46];
  RNAcofold_args_info_full_help[33] = RNAcofold_args_info_detailed_help[47];
  RNAcofold_args_info_full_help[34] = RNAcofold_args_info_detailed_help[49];
  ...
  RNAcofold_args_info_full_help[38] = 0; 
  
}

const char *RNAcofold_args_info_full_help[39];
...
init_help_array(void)
{
  ...
  RNAcofold_args_info_help[13] = RNAcofold_args_info_detailed_help[20];
  RNAcofold_args_info_help[14] = RNAcofold_args_info_detailed_help[21];
  RNAcofold_args_info_help[15] = RNAcofold_args_info_detailed_help[22];
  RNAcofold_args_info_help[16] = RNAcofold_args_info_detailed_help[23];
  RNAcofold_args_info_help[17] = RNAcofold_args_info_detailed_help[24];
  RNAcofold_args_info_help[18] = RNAcofold_args_info_detailed_help[26];
  RNAcofold_args_info_help[19] = RNAcofold_args_info_detailed_help[28];
  RNAcofold_args_info_help[20] = RNAcofold_args_info_detailed_help[30];
  RNAcofold_args_info_help[21] = RNAcofold_args_info_detailed_help[36];
  RNAcofold_args_info_help[22] = RNAcofold_args_info_detailed_help[37];
  RNAcofold_args_info_help[23] = RNAcofold_args_info_detailed_help[38];
  RNAcofold_args_info_help[24] = RNAcofold_args_info_detailed_help[39];
  RNAcofold_args_info_help[25] = RNAcofold_args_info_detailed_help[41];
  RNAcofold_args_info_help[26] = RNAcofold_args_info_detailed_help[43];
  RNAcofold_args_info_help[27] = RNAcofold_args_info_detailed_help[45];
  RNAcofold_args_info_help[28] = RNAcofold_args_info_detailed_help[46];
  RNAcofold_args_info_help[29] = RNAcofold_args_info_detailed_help[47];
  RNAcofold_args_info_help[30] = RNAcofold_args_info_detailed_help[54];
  RNAcofold_args_info_help[31] = 0; 
  
}

const char *RNAcofold_args_info_help[32];
...
void init_args_info(struct RNAcofold_args_info *args_info)
{
  ...
  args_info->constraint_help = RNAcofold_args_info_detailed_help[18] ;
  args_info->canonicalBPonly_help = RNAcofold_args_info_detailed_help[20] ;
  args_info->enforceConstraint_help = RNAcofold_args_info_detailed_help[21] ;
  args_info->partfunc_help = RNAcofold_args_info_detailed_help[24] ;
  args_info->all_pf_help = RNAcofold_args_info_detailed_help[26] ;
  args_info->concentrations_help = RNAcofold_args_info_detailed_help[28] ;
  args_info->concfile_help = RNAcofold_args_info_detailed_help[30] ;
  args_info->pfScale_help = RNAcofold_args_info_detailed_help[32] ;
  args_info->bppmThreshold_help = RNAcofold_args_info_detailed_help[34] ;
  args_info->gquad_help = RNAcofold_args_info_detailed_help[36] ;
  args_info->temp_help = RNAcofold_args_info_detailed_help[38] ;
  args_info->noTetra_help = RNAcofold_args_info_detailed_help[39] ;
  args_info->dangles_help = RNAcofold_args_info_detailed_help[41] ;
  args_info->noLP_help = RNAcofold_args_info_detailed_help[43] ;
  args_info->noGU_help = RNAcofold_args_info_detailed_help[45] ;
  args_info->noClosingGU_help = RNAcofold_args_info_detailed_help[46] ;
  args_info->paramFile_help = RNAcofold_args_info_detailed_help[47] ;
  args_info->nsp_help = RNAcofold_args_info_detailed_help[49] ;
  args_info->energyModel_help = RNAcofold_args_info_detailed_help[51] ;
  args_info->betaScale_help = RNAcofold_args_info_detailed_help[52] ;
