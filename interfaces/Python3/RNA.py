...
class fold_compound(object):
    ...
    def add_auxdata(self, *args) -> "void":
    ...
    def sc_add_data(self, *args) -> "void":
...
class PlistVector(object):
    ...
    def __len__(self) -> "std::vector< vrna_plist_s >::size_type":
        return _RNA.PlistVector___len__(self)

    def __getslice__(self, i: 'std::vector< vrna_plist_s >::difference_type', j: 'std::vector< vrna_plist_s >::difference_type') -> "std::vector< vrna_plist_s,std::allocator< vrna_plist_s > > *":
        return _RNA.PlistVector___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        return _RNA.PlistVector___setslice__(self, *args)

    def __delslice__(self, i: 'std::vector< vrna_plist_s >::difference_type', j: 'std::vector< vrna_plist_s >::difference_type') -> "void":
        return _RNA.PlistVector___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        return _RNA.PlistVector___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::vector< vrna_plist_s >::value_type const &":
        return _RNA.PlistVector___getitem__(self, *args)

    def __setitem__(self, *args) -> "void":
        return _RNA.PlistVector___setitem__(self, *args)

    def pop(self) -> "std::vector< vrna_plist_s >::value_type":
        return _RNA.PlistVector_pop(self)

    def append(self, x: 'std::vector< vrna_plist_s >::value_type const &') -> "void":
        return _RNA.PlistVector_append(self, x)

    def empty(self) -> "bool":
        return _RNA.PlistVector_empty(self)

    def size(self) -> "std::vector< vrna_plist_s >::size_type":
        return _RNA.PlistVector_size(self)

    def swap(self, v: 'PlistVector') -> "void":
        return _RNA.PlistVector_swap(self, v)

    def begin(self) -> "std::vector< vrna_plist_s >::iterator":
        return _RNA.PlistVector_begin(self)

    def end(self) -> "std::vector< vrna_plist_s >::iterator":
        return _RNA.PlistVector_end(self)

    def rbegin(self) -> "std::vector< vrna_plist_s >::reverse_iterator":
        return _RNA.PlistVector_rbegin(self)

    def rend(self) -> "std::vector< vrna_plist_s >::reverse_iterator":
        return _RNA.PlistVector_rend(self)

    def clear(self) -> "void":
        return _RNA.PlistVector_clear(self)

    def get_allocator(self) -> "std::vector< vrna_plist_s >::allocator_type":
        return _RNA.PlistVector_get_allocator(self)

    def pop_back(self) -> "void":
        return _RNA.PlistVector_pop_back(self)

    def erase(self, *args) -> "std::vector< vrna_plist_s >::iterator":
    ...
    def push_back(self, x: 'std::vector< vrna_plist_s >::value_type const &') -> "void":
        return _RNA.PlistVector_push_back(self, x)

    def front(self) -> "std::vector< vrna_plist_s >::value_type const &":
        return _RNA.PlistVector_front(self)

    def back(self) -> "std::vector< vrna_plist_s >::value_type const &":
        return _RNA.PlistVector_back(self)

    def assign(self, n: 'std::vector< vrna_plist_s >::size_type', x: 'std::vector< vrna_plist_s >::value_type const &') -> "void":
    ...
    def reserve(self, n: 'std::vector< vrna_plist_s >::size_type') -> "void":
        return _RNA.PlistVector_reserve(self, n)

    def capacity(self) -> "std::vector< vrna_plist_s >::size_type":
